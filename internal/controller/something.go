...
//go:generate mockgen --build_flags=--mod=mod -destination=./mocks/mock_something.go -package=mocks github.com/eiizu/go-service/internal/controller SomethingUseCase
